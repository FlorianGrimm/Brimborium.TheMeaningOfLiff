    ...
    public OptionalDatumValueDatumFailureDatumDatum<OV, OF> Then<OV, OF>(
        ...
        ) {
        {
            return (this.Mode) switch {
                ...
                OptionalDatumValueDatumFailureDatumMode.Value => (funcValueDatum is not null) ? funcValueDatum(this.ValueDatum, defaultValue) : defaultValue,
                OptionalDatumValueDatumFailureDatumMode.Failure => (funcFailureDatum is not null) ? funcFailureDatum(this.FailureDatum, defaultValue) : defaultValue,
            _ => defaultValue
            };
        }
    }
