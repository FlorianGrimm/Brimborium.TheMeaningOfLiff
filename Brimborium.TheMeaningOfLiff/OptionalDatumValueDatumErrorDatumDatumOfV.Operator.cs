    ...
    public OptionalDatumValueDatumErrorDatumDatum<OV> Then<OV>(
        ...
        try {
            return (this.Mode) switch {
                ...
                OptionalDatumValueDatumErrorDatumMode.Value => (funcValueDatum is not null) ? funcValueDatum(this.ValueDatum, defaultValue) : defaultValue,
                OptionalDatumValueDatumErrorDatumMode.Error => (funcErrorDatum is not null) ? funcErrorDatum(this.ErrorDatum, defaultValue) : this.ErrorDatum,
            _ => defaultValue
            };
