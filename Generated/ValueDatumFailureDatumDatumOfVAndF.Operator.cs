    ...
    public ValueDatumFailureDatumDatum<OV, OF> Then<OV, OF>(
        ...
        ) {
        {
            return (this.Mode) switch {
                ValueDatumFailureDatumMode.Value => (funcValueDatum is not null) ? funcValueDatum(this.Value, defaultValue) : defaultValue,
                ValueDatumFailureDatumMode.Failure => (funcFailureDatum is not null) ? funcFailureDatum(this.Failure, defaultValue) : defaultValue,
            _ => defaultValue
            };
        }
    }
