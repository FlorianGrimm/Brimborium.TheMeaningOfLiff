    ...
    public OptionalDatumValueDatumFailureDatumErrorDatumDatum<OV, OF> Then<OV, OF>(
        ...
        try {
            return (this.Mode) switch {
                ...
                OptionalDatumValueDatumFailureDatumErrorDatumMode.Value => (funcValueDatum is not null) ? funcValueDatum(this.Value, defaultValue) : defaultValue,
                OptionalDatumValueDatumFailureDatumErrorDatumMode.Failure => (funcFailureDatum is not null) ? funcFailureDatum(this.Failure, defaultValue) : defaultValue,
                OptionalDatumValueDatumFailureDatumErrorDatumMode.Error => (funcErrorDatum is not null) ? funcErrorDatum(this.Error, defaultValue) : this.Error,
            _ => defaultValue
            };
