    ...
    public ValueDatumErrorDatumDatum<OV> Then<OV>(
        ...
        try {
            return (this.Mode) switch {
                ValueDatumErrorDatumMode.Value => (funcValueDatum is not null) ? funcValueDatum(this.Value, defaultValue) : defaultValue,
                ValueDatumErrorDatumMode.Error => (funcErrorDatum is not null) ? funcErrorDatum(this.Error, defaultValue) : this.Error,
            _ => defaultValue
            };
