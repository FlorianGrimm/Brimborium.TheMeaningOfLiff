...
// generated 3 Upgrade
    ...
    public static implicit operator OptionalValueFailureDatum<V, F>(OptionalValueDatum<V> value) {
        return (value.Mode) switch {
            OptionalValueMode.NoValue => new OptionalValueFailureDatum<V, F>(OptionalValueFailureMode.NoValue, value.Optional, default, default),
            OptionalValueMode.Value => new OptionalValueFailureDatum<V, F>(OptionalValueFailureMode.Value, default, value.Value, default),
    ...
    public static implicit operator OptionalValueFailureDatum<V, F>(OptionalFailureDatum<F> value) {
        return (value.Mode) switch {
            OptionalFailureMode.NoValue => new OptionalValueFailureDatum<V, F>(OptionalValueFailureMode.NoValue, value.Optional, default, default),
            OptionalFailureMode.Failure => new OptionalValueFailureDatum<V, F>(OptionalValueFailureMode.Failure, default, default, value.Failure),
            _ => throw new InvalidCastException()
        };
    }
    ...
    public static implicit operator OptionalValueFailureDatum<V, F>(ValueFailureDatum<V, F> value) {
        return (value.Mode) switch {
            ValueFailureMode.Value => new OptionalValueFailureDatum<V, F>(OptionalValueFailureMode.Value, default, value.Value, default),
            ValueFailureMode.Failure => new OptionalValueFailureDatum<V, F>(OptionalValueFailureMode.Failure, default, default, value.Failure),
            _ => throw new InvalidCastException()
        };
    }
}
